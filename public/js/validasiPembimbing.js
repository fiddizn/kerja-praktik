...
form.addEventListener('submit', function(event){
    ...
    if (alt1_p1Value == alt2_p1Value ||
        alt1_p1Value == alt3_p1Value ||
        alt1_p1Value == alt4_p1Value ||
        alt2_p1Value == alt3_p1Value ||
        alt2_p1Value == alt4_p1Value ||
        alt3_p1Value == alt4_p1Value)
    {
        alert('Alternatif Pembimbing 1 tidak boleh sama!');
    ...
    if (alt1_p2Value == alt2_p2Value ||
        alt1_p2Value == alt3_p2Value ||
        alt1_p2Value == alt4_p2Value ||
        alt2_p2Value == alt3_p2Value ||
        alt2_p2Value == alt4_p2Value ||
        alt3_p2Value == alt4_p2Value)
    {
        alert('Alternatif Pembimbing 2 tidak boleh sama!');
        event.preventDefault();
    }

    if(alt1_p1Value == alt1_p2Value ||
       alt2_p1Value == alt2_p2Value ||
       alt3_p1Value == alt3_p2Value ||
       alt4_p1Value == alt4_p2Value )
    {
