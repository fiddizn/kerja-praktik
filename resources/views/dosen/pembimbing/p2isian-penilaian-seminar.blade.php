    ...
    <div class="form-group row mt-4">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p2_materi" name="p2_materi" placeholder="Skor maksimal 20"
                min="0" max="20" value="{{ $penilaianSeminar->p2_materi }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p2_pemahaman" name="p2_pemahaman"
                placeholder="Skor maksimal 20" min="0" max="20" value="{{ $penilaianSeminar->p2_pemahaman }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p2_pencapaian" name="p2_pencapaian"
                placeholder="Skor maksimal 30" min="0" max="30" value="{{ $penilaianSeminar->p2_pencapaian }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p2_kedisiplinan" name="p2_kedisiplinan"
                placeholder="Skor maksimal 30" min="0" max="30" value="{{ $penilaianSeminar->p2_kedisiplinan}}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="p2_catatan" name="p2_catatan"
                value="{{ $penilaianSeminar->p2_catatan }}">
        </div>
    </div>
    <div class="form-group row">
