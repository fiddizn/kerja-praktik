...
<form id="formSeminar" method="post" action="/dosen/pembimbing-1/penilaian-seminar/{{ $penilaianSeminar->id }}/edit"
    ...
    <div class="row">
        ...
        <div class="form-group row">
            ...
            <div class="">
                <input class="form-control @error('p1_file') is-invalid @enderror" type="file" id="p1_file"
                    name="p1_file">
                <div id="p1_file" class="invalid-feedback">File harus berupa WORD/PDF!</div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/js/catatanSeminarP1.js"></script>
@endsection