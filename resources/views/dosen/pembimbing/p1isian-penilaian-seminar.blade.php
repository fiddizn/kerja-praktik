    ...
    <div class="form-group row mt-4">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p1_materi" name="p1_materi" placeholder="Skor maksimal 20"
                min="0" max="20" value="{{ $penilaianSeminar->p1_materi }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p1_pemahaman" name="p1_pemahaman"
                placeholder="Skor maksimal 20" min="0" max="20" value="{{ $penilaianSeminar->p1_pemahaman }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p1_pencapaian" name="p1_pencapaian"
                placeholder="Skor maksimal 30" min="0" max="30" value="{{ $penilaianSeminar->p1_pencapaian }}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" class="form-control" id="p1_kedisiplinan" name="p1_kedisiplinan"
                placeholder="Skor maksimal 30" min="0" max="30" value="{{ $penilaianSeminar->p1_kedisiplinan}}">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="p1_catatan" name="p1_catatan"
                value="{{ $penilaianSeminar->p1_catatan }}">
        </div>
    </div>
    <div class="form-group row">
