...
<div class="row align-items-start mt-3">
    <div class="row g-3">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="/dosen/ajuan-pembimbing/{{$pendaftaran->id}}/downloadBerkasTA1">Download
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <a class="btn" style="width: 12rem; background-color:#ff8c1a;"
                    href="/dosen/ajuan-pembimbing/{{$pendaftaran->id}}/downloadKHS">Download <i
    ...
    <div class="col-12 mt-5">
        <a class="btn" href="{{ route('ajuan-pembimbing.index') }}" role="button"
