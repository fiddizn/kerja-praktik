...
<div class="form-group row mt-4">
    ...
    <div class="col-sm-3">
        <input type="number" class="form-control" id="r1_presentasi" name="r1_presentasi"
            value="{{ $penilaianSeminar->r1_presentasi }}" disabled>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <input type="number" class="form-control" id="r1_dokumentasi" name="r1_dokumentasi"
            value="{{ $penilaianSeminar->r1_dokumentasi }}" disabled>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <input type="number" class="form-control" id="r1_rumusanMasalah" name="r1_rumusanMasalah"
            value="{{ $penilaianSeminar->r1_rumusanMasalah }}" disabled>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <input type="number" class="form-control" id="r1_metodeDanPustaka" name="r1_metodeDanPustaka"
            value="{{ $penilaianSeminar->r1_metodeDanPustaka }}" disabled>
    </div>
</div>
<div class="form-group row">
...
<div class="position-relative">
    ...
    <a class="btn my-3
    " href="/dosen/reviewer-1/penilaian-seminar/{{ $penilaianSeminar->id }}/edit" role="button"
