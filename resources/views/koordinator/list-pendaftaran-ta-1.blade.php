    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-warning" href="/koordinator/list-pendaftaran-ta-1/{{ $pendaftaran->id }}/edit"><i
                        class="fa-regular fa-pen-to-square"></i> Edit</a>
                <form action="/koordinator/list-pendaftaran-ta-1/{{ $pendaftaran->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                    <button class="btn btn-danger" role="button" onclick="return confirm('Apakah anda yakin?')"><i
