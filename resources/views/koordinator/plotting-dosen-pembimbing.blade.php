...
<table class="table table-hover table-sm mt-3">
    <thead>
        <tr>
            ...
            <th scope="col">P1
                @if ($sortAsc == 'ASC' && $sortBy == 'p1')
                <a
                    href="{{request()->getPathInfo()}}?search={{$search}}&sortBy=p1&sortAsc={{$sortAsc=='ASC'&&$sortBy=='p1'?'DESC':'ASC'}}">
                    <span wire:click="sortBy('name')" style="cursor: pointer;">
                        <i class="fa-solid fa-arrow-up fa-xs "></i>
                        <i class="fa-solid fa-arrow-down fa-xs text-muted"></i>
                    </span>
                </a>
                @elseif ($sortAsc == 'DESC' && $sortBy == 'p1')
                <a
                    href="{{request()->getPathInfo()}}?search={{$search}}&sortBy=p1&sortAsc={{$sortAsc=='ASC'&&$sortBy=='p1'?'DESC':'ASC'}}">
                    <span wire:click="sortBy('name')" style="cursor: pointer;">
                        <i class="fa-solid fa-arrow-up fa-xs text-muted"></i>
            ...
            <th scope="col">P2
                @if ($sortAsc == 'ASC' && $sortBy == 'p2')
                <a
                    href="{{request()->getPathInfo()}}?search={{$search}}&sortBy=p2&sortAsc={{$sortAsc=='ASC'&&$sortBy=='p2'?'DESC':'ASC'}}">
                    <span wire:click="sortBy('name')" style="cursor: pointer;">
                        <i class="fa-solid fa-arrow-up fa-xs "></i>
                        <i class="fa-solid fa-arrow-down fa-xs text-muted"></i>
                    </span>
                </a>
                @elseif ($sortAsc == 'DESC' && $sortBy == 'p2')
                <a
                    href="{{request()->getPathInfo()}}?search={{$search}}&sortBy=p2&sortAsc={{$sortAsc=='ASC'&&$sortBy=='p2'?'DESC':'ASC'}}">
                    <span wire:click="sortBy('name')" style="cursor: pointer;">
                        <i class="fa-solid fa-arrow-up fa-xs text-muted"></i>
