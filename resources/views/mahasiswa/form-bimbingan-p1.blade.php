...
<div class="row align-items-start">
    <div class="row g-1 ps-4">
        ...
        <div class="col-md-6">
            <label for="name" class="form-label">Nama Pembimbing 1</label>
...
<div class="p-2 mt-2">
    <a class="btn" style="background-color:#ff8c1a; width: 8rem;"
        href="/mahasiswa/form-bimbingan/pembimbing-1/create"><i class="fa-solid fa-plus"></i>
        Bimbingan</a>
</div>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-warning"
                    href="/mahasiswa/form-bimbingan/pembimbing-1/{{ $bimbingans->firstItem()+ $key}}/edit"><i
                        class="fa-solid fa-pen-to-square"></i> Update</a>
            </td>
            @else
            <td><a class="btn btn-warning"
                    href="/mahasiswa/form-bimbingan/pembimbing-1/{{ $bimbingans->firstItem()+ $key}}"><i
