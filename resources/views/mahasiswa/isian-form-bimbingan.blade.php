...
@if($bimbingan_ke == null)
@if ($is_p1)
<form class="row my-2" action="/mahasiswa/form-bimbingan/pembimbing-1/create" method="POST">
    @else
    <form class="row my-2" action="/mahasiswa/form-bimbingan/pembimbing-2/create" method="POST">
        @endif
        @else
